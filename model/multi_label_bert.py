...
class MultiLabelModel(pl.LightningModule):
    def __init__(self,  
        ...
        self.auroc_macro = MultilabelAUROC(num_labels = len(self.labels), average = "micro")
        ...
        self.f1_macro = MultilabelF1Score(num_labels=len(self.labels), average='micro')
    ...
    def forward(self, input_ids, token_type_ids, attention_mask):
        ...
        # hidden_state = hidden_state[8:12]
        # hidden_state = self.pre_classifier(hidden_state.pooler_output)
        # logit = self.dropout(hidden_state)
        # logit = self.l1(logit)
        ...
        out = self.pre_classifier(hidden_state)
        out = self.relu(out)
